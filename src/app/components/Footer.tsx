...
<section className="py-10 bg-blue-900 sm:pt-16 lg:pt-24">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 container max-w-6xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-12 container max-w-6xl">
            <div className="">
                <p className="text-xl font-extrabold p-2 mr-4 text-white">Ingressos Online</p>
